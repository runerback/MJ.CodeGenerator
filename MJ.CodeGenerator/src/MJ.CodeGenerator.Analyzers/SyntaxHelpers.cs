...
namespace MJ.CodeGenerator.Analyzers
{
    ...
    {
        public static bool TryGetAttribute(this MemberDeclarationSyntax member, string attributeName, [NotNullWhen(true)] out AttributeSyntax? attribute)
        {
        ...
        public static bool TryGetTypeName(this AttributeSyntax attributeSyntax, [NotNullWhen(true)] out string? typeName)
        {
        ...
        public static bool IsAttribute(this AttributeSyntax attributeSyntax, string attributeName) =>
            attributeSyntax.TryGetTypeName(out var name) && (
                string.Equals(name, attributeName, StringComparison.Ordinal) || (
                    name.StartsWith(attributeName, StringComparison.Ordinal) &&
                    name.EndsWith(nameof(Attribute), StringComparison.Ordinal) &&
                    name.Length == attributeName.Length + nameof(Attribute).Length));
